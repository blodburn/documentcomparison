...
7. 내보내기
‘Excel 내보내기’는 비교 결과를 XLSX로 저장합니다. ‘Word 변경추적’은 변경 전 → 변경 후 조합을 선택해 Word 변경추적 문서를 만듭니다. DOCX를 변경 후 문서(B)로 선택하면 B의 표·이미지·스타일·번호·콘텐츠 컨트롤 등 양식을 유지합니다. 화면 비교에서 확정된 조/문단 계보를 Word 내보내기에도 우선 적용하고, 전체 문단의 추가·삭제는 문단표시까지 변경추적으로 기록합니다.
...
"""
        : """
Document Compare V5.20.12 · Quick Guide
